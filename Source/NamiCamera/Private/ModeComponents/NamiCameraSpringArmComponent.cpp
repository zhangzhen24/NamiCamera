...
#include UE_INLINE_GENERATED_CPP_BY_NAME(NamiCameraSpringArmComponent)

UNamiCameraSpringArmComponent::UNamiCameraSpringArmComponent()
{
	ComponentName = TEXT("SpringArm");
...
void UNamiCameraSpringArmComponent::Initialize_Implementation(UNamiCameraModeBase* InCameraMode)
{
...
void UNamiCameraSpringArmComponent::Activate_Implementation()
{
...
void UNamiCameraSpringArmComponent::ApplyToView_Implementation(FNamiCameraView& InOutView, float DeltaTime)
{
...
TArray<AActor*> UNamiCameraSpringArmComponent::GetIgnoreActors_Implementation() const
{
